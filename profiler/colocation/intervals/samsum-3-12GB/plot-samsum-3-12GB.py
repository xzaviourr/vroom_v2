...
plt.xlabel(f'Total GPU cores percentage (Divided equally among the {num_colocation} workloads)')
...
plt.suptitle(f"Throughput, Utilization and Latency distribution for {num_colocation} colocated workloads running with {memory/num_colocation}GB memory each")
