...
if __name__ == "__main__":
    pods = [
        [Pod(2, 40), Pod(2, 40), Pod(2, 40)],   # 6, 120
        [Pod(2, 60), Pod(2, 60), Pod(2, 60)],   # 6, 180
        [Pod(2, 80), Pod(2, 80), Pod(2, 80)],   # 6, 240
        [Pod(2, 100), Pod(2, 100), Pod(2, 100)],   # 6, 300

        [Pod(4, 40), Pod(2, 40), Pod(2, 40)],   # 8, 120
        [Pod(4, 60), Pod(2, 60), Pod(2, 60)],   # 8, 180
        [Pod(4, 80), Pod(2, 80), Pod(2, 80)],   # 8, 240
        [Pod(4, 100), Pod(2, 100), Pod(2, 100)],   # 8, 300

        [Pod(4, 40), Pod(4, 40), Pod(2, 40)],   # 10, 120
        [Pod(4, 60), Pod(4, 60), Pod(2, 60)],   # 10, 180
        [Pod(4, 80), Pod(4, 80), Pod(2, 80)],   # 10, 240
        [Pod(4, 100), Pod(4, 100), Pod(2, 100)],   # 10, 300

        [Pod(4, 40), Pod(4, 40), Pod(4, 40)],   # 12, 120
        [Pod(4, 60), Pod(4, 60), Pod(4, 60)],   # 12, 180
        [Pod(4, 80), Pod(4, 80), Pod(4, 80)],   # 12, 240
        [Pod(4, 100), Pod(4, 100), Pod(4, 100)],   # 12, 300

        [Pod(6, 40), Pod(4, 40), Pod(4, 40)],   # 14, 120
        [Pod(6, 60), Pod(4, 60), Pod(4, 60)],   # 14, 180
        [Pod(6, 80), Pod(4, 80), Pod(4, 80)],   # 14, 240
        [Pod(6, 100), Pod(4, 100), Pod(4, 100)],   # 14, 300
    ]
