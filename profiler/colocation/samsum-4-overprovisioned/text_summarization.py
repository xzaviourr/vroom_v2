...
def run_simulation(pods:List, load:List):
    for pod in pods:
        ...
        create_pod_yaml(pod[3].memory, pod[3].compute, "ts4", 5555, 12348)
        subprocess.run(["kubectl", "apply", "-f", "pod_request.yaml"])
        subprocess.run(["kubectl", "apply", "-f", "pod_service.yaml"])
...
if __name__ == "__main__":
    pods = [
        [Pod(2, 30), Pod(2, 30), Pod(2, 30), Pod(2, 30)],   # 8, 120
        [Pod(2, 50), Pod(2, 50), Pod(2, 50), Pod(2, 50)],   # 8, 200
        [Pod(2, 75), Pod(2, 75), Pod(2, 75), Pod(2, 75)],   # 8, 300
        [Pod(2, 100), Pod(2, 100), Pod(2, 100), Pod(2, 100)],   # 8, 400

        [Pod(4, 30), Pod(2, 30), Pod(2, 30), Pod(2, 30)],   # 10, 120
        [Pod(4, 50), Pod(2, 50), Pod(2, 50), Pod(2, 50)],   # 10, 200
        [Pod(4, 75), Pod(2, 75), Pod(2, 75), Pod(2, 75)],   # 10, 300
        [Pod(4, 100), Pod(4, 100), Pod(2, 100), Pod(2, 100)],   # 10, 400

        [Pod(4, 30), Pod(4, 30), Pod(2, 30), Pod(2, 30)],   # 12, 120
        [Pod(4, 50), Pod(4, 50), Pod(2, 50), Pod(2, 50)],   # 12, 200
        [Pod(4, 75), Pod(4, 75), Pod(2, 75), Pod(2, 75)],   # 12, 300
        [Pod(4, 100), Pod(4, 100), Pod(2, 100), Pod(2, 100)],   # 12, 400

        [Pod(4, 30), Pod(4, 30), Pod(4, 30), Pod(2, 30)],   # 14, 120
        [Pod(4, 50), Pod(4, 50), Pod(4, 50), Pod(2, 50)],   # 14, 200
        [Pod(4, 75), Pod(4, 75), Pod(4, 75), Pod(2, 75)],   # 14, 300
        [Pod(4, 100), Pod(4, 100), Pod(4, 100), Pod(2, 100)],   # 14, 400
    ]
