...
if __name__ == "__main__":
    pods = [
        [Pod(2, 60), Pod(2, 60)],   # 4, 120
        [Pod(2, 70), Pod(2, 70)],   # 4, 140
        [Pod(2, 80), Pod(2, 80)],   # 4, 160
        [Pod(2, 90), Pod(2, 90)],   # 4, 180
        [Pod(2, 100), Pod(2, 100)],   # 4, 200
        [Pod(2, 60), Pod(4, 60)],   # 6, 120
        [Pod(2, 70), Pod(4, 70)],   # 6, 140
        [Pod(2, 80), Pod(4, 80)],   # 6, 160
        [Pod(2, 90), Pod(4, 90)],   # 6, 180
        [Pod(2, 100), Pod(4, 100)],   # 6, 200
        [Pod(4, 60), Pod(4, 60)],   # 8, 120
        [Pod(4, 70), Pod(4, 70)],   # 8, 140
        [Pod(4, 80), Pod(4, 80)],   # 8, 160
        [Pod(4, 90), Pod(4, 90)],   # 8, 180
        [Pod(4, 100), Pod(4, 100)],   # 8, 200
        [Pod(4, 60), Pod(6, 60)],   # 10, 120
        [Pod(4, 70), Pod(6, 70)],   # 10, 140
        [Pod(4, 80), Pod(6, 80)],   # 10, 160
        [Pod(4, 90), Pod(6, 90)],   # 10, 180
        [Pod(4, 100), Pod(6, 100)],   # 10, 200
        ...
        [Pod(6, 60), Pod(8, 60)],   # 14, 120
        [Pod(6, 70), Pod(8, 70)],   # 14, 140
        [Pod(6, 80), Pod(8, 80)],   # 14, 160
        [Pod(6, 90), Pod(8, 90)],   # 14, 180
        [Pod(6, 100), Pod(8, 100)],   # 14, 200
    ]
