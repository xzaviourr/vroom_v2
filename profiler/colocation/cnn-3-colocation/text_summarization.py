...
def run_simulation(pods:List, load:List):
    for pod in pods:
        ...
        for num_requests in load:
            ...
            throughput, latency = asyncio.run(measure_overall_throughput(num_requests, ["ts1", "ts2", "ts3"], [12345, 12346, 12347]))

            output_str = f"{pod[0].memory},{pod[0].compute},{pod[1].memory},{pod[1].compute},{pod[2].memory},{pod[2].compute},{round(startup_time,3)},{num_requests},{round(throughput,3)},{round(latency,3)}\n"
...
if __name__ == "__main__":
    pods = [
        [Pod(2, 10), Pod(2, 10), Pod(2, 10)],   # 6, 30
        [Pod(2, 10), Pod(2, 10), Pod(2, 20)],   # 6, 40
        [Pod(2, 20), Pod(2, 20), Pod(2, 20)],   # 6, 60
        [Pod(2, 30), Pod(2, 30), Pod(2, 20)],   # 6, 80
        [Pod(2, 40), Pod(2, 30), Pod(2, 30)],   # 6, 100
        [Pod(4, 10), Pod(2, 10), Pod(2, 10)],   # 8, 30
        [Pod(4, 10), Pod(2, 10), Pod(2, 20)],   # 8, 40
        [Pod(4, 20), Pod(2, 20), Pod(2, 20)],   # 8, 60
        [Pod(4, 30), Pod(2, 30), Pod(2, 20)],   # 8, 80
        [Pod(4, 40), Pod(2, 30), Pod(2, 30)],   # 10, 100
        [Pod(4, 10), Pod(4, 10), Pod(2, 10)],   # 10, 30
        [Pod(4, 10), Pod(4, 10), Pod(2, 20)],   # 10, 40
        [Pod(4, 20), Pod(4, 20), Pod(2, 20)],   # 10, 60
        [Pod(4, 30), Pod(4, 30), Pod(2, 20)],   # 10, 80
        [Pod(4, 40), Pod(4, 30), Pod(2, 30)],   # 10, 100
        [Pod(4, 10), Pod(4, 10), Pod(4, 10)],   # 12, 30
        [Pod(4, 10), Pod(4, 10), Pod(4, 20)],   # 12, 40
        [Pod(4, 20), Pod(4, 20), Pod(4, 20)],   # 12, 60
        [Pod(4, 30), Pod(4, 30), Pod(4, 20)],   # 12, 80
        [Pod(4, 40), Pod(4, 30), Pod(4, 30)],   # 12, 100
        [Pod(6, 10), Pod(4, 10), Pod(4, 10)],   # 14, 30
        [Pod(6, 10), Pod(4, 10), Pod(4, 20)],   # 14, 40
        [Pod(6, 20), Pod(4, 20), Pod(4, 20)],   # 14, 60
        [Pod(6, 30), Pod(4, 30), Pod(4, 20)],   # 14, 80
        [Pod(6, 40), Pod(4, 30), Pod(4, 30)],   # 14, 100
    ]
    load = [2, 4, 8, 16, 32, 64, 128]

    output_str = f"memory1,compute1,memory2,compute2,memory3,compute3,startup_time,load,throughput,latency\n"
    with open("results.csv", 'a') as file:
        file.write(output_str)
