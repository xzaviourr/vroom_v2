...
if __name__ == "__main__":
    ...
    pods = [
        ...
        [Pod(4, 60), Pod(4, 60), Pod(4, 60)],
        [Pod(4, 80), Pod(4, 80), Pod(4, 80)],
        [Pod(4, 100), Pod(4, 100), Pod(4, 100)],
    ]
    s = ""
    for ind in range(1, num_colocation+1):
        s += f"memory{ind},compute{ind},"
    ...
    pods = [
        ...
        [Pod(3, 60), Pod(3, 60), Pod(3, 60), Pod(3, 60)],
        [Pod(3, 80), Pod(3, 80), Pod(3, 80), Pod(3, 80)],
        [Pod(3, 100), Pod(3, 100), Pod(3, 100), Pod(3, 100)],
    ]
    s = ""
    for ind in range(1, num_colocation+1):
        s += f"memory{ind},compute{ind},"
